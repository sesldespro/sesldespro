...
<?php
    include("../sub/expiry.php");
    include("../sub/subnotice.php");
?>
...
<body>
    ...
    <div class="dashboard-container">
        <div class="navigation">
            <?php include("../sub/getfullname.php"); ?>
        </div>
        <div class="container-cards">
            <div class="rent-activities">
                <div class="rent">
                    <div class="locker-content">
                        ...
                        <div class="top-locker">
                            <?php include("../sub/rentdetails.php");?>
                        </div>
                        <div class="rent-detail-title">
                            <h3>SESL Video</h3>
                        </div>
                        <div class="sesl-video">
                            <object width="390" height="220" data="http://www.youtube.com/v/Jc00byVIJ7I" type="application/x-shockwave-flash"><param name="src" value="http://www.youtube.com/v/Jc00byVIJ7I" /></object>
                        </div>
                    </div>
                </div>
                <div class="activities">
                    <h3>Recent Activities <a href="../sub/activity.php"><span class="see-text">See all</span></a></h3>
                    <div class="table-head">
                        ...
                        <th>Rent Ended</th>
                            ...
                            <?php
                                ...
                                $queryactivity = "SELECT * FROM locker_rental WHERE acct_num=$g_user_id order by rent_date DESC LIMIT 3";
                                $queryresult = (mysqli_query($dbcon, $queryactivity));
                                while($activityfetch = mysqli_fetch_array($queryresult)){
                                    $A_acctno               = $activityfetch['1'];
                                    $A_renteddate           = $activityfetch['2'];
                                    $A_rentedtime           = $activityfetch['3'];
                                    $A_rentedenddate        = $activityfetch['4'];
                                    $A_rentedendtime        = $activityfetch['5'];
                                    $A_fullname             = $activityfetch['6'];
                                    $A_lockerno             = $activityfetch['9'];
                                    $A_size                 = $activityfetch['10'];
