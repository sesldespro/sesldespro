...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/css/contactus.css">
    <link rel="stylesheet" href="../../public/css/css_responsive/contactus.css">
</head>
<body>
    ...
    <div class="contactus-container">
        <div class="navigation">
            <h1><a href="../sub/setting.php">Settings </a> > Contact Us</h1>
            <!-- <button class="rent-btn gradient-button" type="submit"><svg width="15" height="16" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13 2V24M2 13H24" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>RENT</button> -->
        </div>
            ...
            <div class="contactus-email">
                <div class="contact-content">
                    <svg class="contact-icons"width="130" height="133" viewBox="0 0 130 133" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p><a class="text-fade" href="https://accounts.google.com/servicelogin/signinchooser?flowName=GlifWebSignIn&flowEntry=ServiceLogin" target="blank">  sesldespro@gmail.com</a></p>
                </div>
            </div>
