...
<head>
    ...
    <title>SESL | Help</title>
    <link rel="stylesheet" href="../public/css/css/help.css" />
    <link rel="stylesheet" href="../public/css/css_responsive/help.css">
</head>
<body>
    <nav class="home-navi">
        ...
        <div class="settings-content">
            <div class="contactus-email">
                <div class="contact-content">
                    <svg class="contact-icons"width="130" height="133" viewBox="0 0 130 133" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M125 17C125 10.4 119.6 5 113 5H17C10.4 5 5 10.4 5 17M125 17V89C125 95.6 119.6 101 113 101H17C10.4 101 5 95.6 5 89V17M125 17L65 59L5 17" stroke="url(#paint0_linear_734_278)" stroke-width="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <defs>
                        <linearGradient id="paint0_linear_734_278" x1="64.9991" y1="-1.71994" x2="64.9991" y2="107.72" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#2D3A5E"/>
                        <stop offset="0.505208" stop-color="#3C817E"/>
                        <stop offset="1" stop-color="#B1A583"/>
                        </linearGradient>
                        </defs>
                        </svg>                        
            ...
            <div class="contactus-phone">
                <div class="contact-content">
                    <svg class="contact-icons" width="125" height="130" viewBox="0 0 125 130" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M119.286 85.7808V123.939C119.286 124.515 118.825 124.97 118.252 124.922C111.08 124.318 68.2573 119.686 42.1429 93.5714C9.27933 60.7079 5.44842 13.4005 5.04448 5.99192C5.01384 5.4301 5.46419 5 6.02685 5H41.3621C41.8209 5 42.2209 5.3123 42.3322 5.75746L50.577 38.7364C50.6622 39.0772 50.5623 39.4377 50.3139 39.6861L39.7862 50.2138C39.4863 50.5137 39.4084 50.9697 39.5964 51.3498C41.0203 54.2296 47.1298 66.231 53.5714 73.5714C58.9355 79.684 69.8408 87.9439 72.8102 90.1522C73.2394 90.4714 73.8346 90.3853 74.1687 89.9677L84.5991 76.9297C84.8434 76.6243 85.2432 76.4894 85.6225 76.5842L118.528 84.8106C118.973 84.9219 119.286 85.3219 119.286 85.7808Z" stroke="url(#paint0_linear_734_277)" stroke-width="10" stroke-linecap="round"/>
                        <defs>
                        <linearGradient id="paint0_linear_734_277" x1="62.1429" y1="5" x2="62.1429" y2="125" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#2D3A5E"/>
                        <stop offset="0.453125" stop-color="#3C817E"/>
                        <stop offset="1" stop-color="#B1A583"/>
                        </linearGradient>
                        </defs>
                        </svg>
