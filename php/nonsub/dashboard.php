...
if(isset($_POST['resubscribe'])){
    ...
    if(empty($avail_locker))
    {
      ...
      echo "<script>window.open('resubscribe.php','_self')</script>";
    }
}
...
<body>
    ...
    <div class="dashboard-container">
        <div class="navigation">
            <?php include("../nonsub/getfullname.php"); ?>
        </div>
        <div class="resub-container">
            <div class="resub-txt-container">
                <img src="../../images/aboutus-img.png" class="resub-image">
                <p>Oh no, your package might be here but you are not fully subscribed yet.</p>
                <p>Have you paid already? Wait for the admin to confirm your payment.</p><br>
                <p>Or is it your subscription that expired? Resubscribe now for only 99 pesos. Just click the button below.</p>
            </div>
            <div class="resub-button">
                <form action="dashboard.php" method="POST">
                    <button class="rent-btn gradient-button" name="resubscribe" type="submit">Resubscribe</button>
                </form>
            </div>
        </div>
