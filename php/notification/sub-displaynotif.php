<?php
    ...
    $displaynotif5 = "SELECT * FROM `user_info` WHERE `fullname`='$g_fullname' AND `end_notice`='unread' order by sub_time ASC";
    $rundisplaynotif5 = mysqli_query($dbcon, $displaynotif5);

        while($row = mysqli_fetch_array($rundisplaynotif5)){
            $user_id      = $row['0'];
            $username     = $row['1'];
            $fullname     = $row['2'];
            $address      = $row['3'];
            ...
            echo'<a href="../notification/sub-readnotif4.php" class="viewnotif" style="color:black; font-size: 18px;">
                    <div class="notif-content" style="display:flex; align-items: center; margin: 0px 50px; height:fit-content;">
                        ...
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="displaynotif" style="background-color: #ffffff; margin-bottom: 20px; margin:auto; width: 100%;  "> You have less than 24 hours on your subscription. It will end on <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$sub_enddate.'</span> at <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$sub_endtime.'</span>. <br><span style="color:#87898D; font-size: 15px;">'.$todaydate.' | ' .$todaytime. '</span> <br>
                            </div>
                        </div>
                    </div>
                </a>';
    ...
    $rundisplaynotif3 = mysqli_query($dbcon, $displaynotif3);
        ...
        while($row = mysqli_fetch_array($rundisplaynotif3)){
            ...
            echo'<a href="../notification/sub-readnotif2.php" class="viewnotif" style="color:black; font-size: 18px;">
                    <div class="notif-content" style="display:flex; align-items: center; margin: 0px 50px; height:fit-content;">
                        <div class="notif-icon" style="display:flex; margin-bottom: 20px; align-items: center; width: 100%; height:fit-content;
                        background-color: #ffffff; border-radius: 10px; padding: 0px 20px;">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    $rundisplaynotif4 = mysqli_query($dbcon, $displaynotif4);
        ...
        while($row = mysqli_fetch_array($rundisplaynotif4)){
            ...
            echo'<a href="../notification/sub-readnotif3.php" class="viewnotif" style="color:black; font-size: 18px;">
                    <div class="notif-content" style="display:flex; align-items: center; margin: 0px 50px; height:fit-content;">
                        <div class="notif-icon" style="display:flex; margin-bottom: 20px; align-items: center; width: 100%; height:fit-content;
                        background-color: #ffffff; border-radius: 10px; padding: 0px 20px;">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    $rundisplaynotif = mysqli_query($dbcon, $displaynotif);
        ...
        while($row = mysqli_fetch_array($rundisplaynotif)){
            ...
            echo'<a href="../notification/sub-readnotif.php" class="viewnotif" style="color:black; font-size: 18px;">
                    <div class="notif-content" style="display:flex; align-items: center; margin: 0px 50px; height:fit-content;">
                        <div class="notif-icon" style="display:flex; margin-bottom: 20px; align-items: center; width: 100%; height:fit-content;
                        background-color: #ffffff; border-radius: 10px; padding: 0px 20px;">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    $runquerynotif1 = mysqli_query($dbcon, $querynotif1);
        ...
        echo'<a href="../notification/sub-readnotif1.php" class="viewnotif" style="color:black; font-size: 18px;">
                <div class="notif-content" style="display:flex;  align-items: center; margin: 0px 50px; height:fit-content;">
                    <div class="notif-icon" style="display:flex;  margin-bottom: 20px;  align-items: center; width: 100%; height:fit-content;
                    background-color: #ffffff; border-radius: 10px; padding: 0px 20px;">
                    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="notif-content" style="display:flex;  align-items: center; margin: 0px 50px; height:fit-content;">
                        ...
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="displaynotif1" style="background-color: #EFEFEF; margin-bottom: 20px;  margin:auto; width: 100%; ">
                                Oh Hello There! <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$g_fullname.'</span> you are now a <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$user_sub_plan.'</span> subscriber! Enjoy! <br><span style="color:#87898D; font-size: 15px;">'.$user_sub_date.' | ' .$user_sub_time. '</span><br>
                            </div>
                        </div>
                    </div>
                </a>';
    ...
    $displayread5 = "SELECT * FROM `user_info` WHERE `fullname`='$g_fullname' AND `end_notice`='read' order by sub_time ASC";
    $rundisplayread5 = mysqli_query($dbcon, $displayread5);

        while($row = mysqli_fetch_array($rundisplayread5)){
            $user_id      = $row['0'];
            $username     = $row['1'];
            $fullname     = $row['2'];
            $address      = $row['3'];
            ...
            echo'<a href="" class="viewnotif" style="color:black; font-size: 18px;">
                    <div class="notif-content" style="display:flex; align-items: center; margin: 0px 50px; height:fit-content;">
                        <div class="notif-icon" style="display:flex; margin-bottom: 20px; align-items: center; width: 100%; height:fit-content;
                        background-color: #ffffff; border-radius: 10px; padding: 0px 20px;">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="displaynotif" style="background-color: #ffffff; margin-bottom: 20px; margin:auto; width: 100%;  "> You have less than 24 hours on your subscription. It will end on <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$sub_enddate.'</span> at <span style="color:#576FB0; font-size: 18px; font-weight:bold;">'.$sub_endtime.'</span>. <br><span style="color:#87898D; font-size: 15px;">'.$rent_date.' | ' .$rent_time. '</span> <br>
                            </div>
                        </div>
                    </div>
                </a>';
